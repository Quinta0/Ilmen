...
Item {
    ...
    function doSettings() {
        ...
        GlobalStates.sidebarRightOpen = false
        Qt.callLater(() => Quickshell.execDetached(["qs", "-c", "ii", "ipc", "call", "settings", "open"]))
    }
    ...
    component QuickActionsSection: ColumnLayout {
        ...
        GridLayout {
            ...
            QuickActionButton {
                ...
                onClicked: {
                    GlobalStates.sidebarRightOpen = false
                    Qt.callLater(() => Quickshell.execDetached(["qs", "-c", "ii", "ipc", "call", "region", "screenshot"]))
                }
            }
            ...
            QuickActionButton {
                ...
                onClicked: {
                    GlobalStates.sidebarRightOpen = false
                    Qt.callLater(() => Quickshell.execDetached(["qs", "-c", "ii", "ipc", "call", "region", "record"]))
                }
            }
            ...
            QuickActionButton {
                ...
                onClicked: {
                    GlobalStates.sidebarRightOpen = false
                    Qt.callLater(() => Quickshell.execDetached(["qs", "-c", "ii", "ipc", "call", "region", "ocr"]))
                }
            }
            ...
            QuickActionButton {
                ...
                onClicked: {
                    GlobalStates.sidebarRightOpen = false
                    Qt.callLater(() => Quickshell.execDetached(["qs", "-c", "ii", "ipc", "call", "region", "search"]))
                }
            }
